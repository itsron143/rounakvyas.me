...
<h3>Backdrop</h3>
For my bachelor thesis, I was interning at <XA href="https://cetbwh.org">Harvard Medical School</XA> from January to June 2020 working on object detection algorithms for acne lesions. I was dwelling in Boston near the famous CITGO sign. 

Almost every other day, I used to walk my way to the lab across the Charles river making use of the Harvard Bridge. 
...
_Smoot lay down on the bridge, his fraternity brothers marked his head and feet, then he moved down one length and the process was repeated until the entire length of the bridge had been measured._
