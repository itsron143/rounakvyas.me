...
const Index = () => (
  <Layout>
    ...
    <h2>Colophon</h2>
    <p>The credits for this excellet template goes to <XA href="https://twitter.com/prestonrichey">Preston Richey</XA>. This site was made with <XA href="https://www.gatsbyjs.org/">Gatsby.js</XA> and is hosted on <XA href="https://www.netlify.com/">Netlify</XA>. You can look at its code <XA href="https://github.com/itsron717">here</XA>. The monospace font is <XA href="https://fonts.google.com/specimen/Roboto+Mono">Roboto Mono</XA> and the sans-serif is <XA href="https://fonts.google.com/specimen/Rubik">Rubik</XA>.</p>
  </Layout>
);
